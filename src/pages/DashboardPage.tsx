...
const DashboardPage = () => {
  return (
    <div>
      <div className="flex flex-col space-y-2 lg:space-y-0 pl-[14%] lg:pl-[90px] p-2 bg-white h-screen">
        <div className="flex flex-col lg:flex-row bg-gray-200 h-full py-4">
