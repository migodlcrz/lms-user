          ...
          <div className="flex flex-col justify-between h-[92%]">
            <ul className="flex flex-col space-y-6">
              <button
                ...
                className={`flex flex-row items-center justify-center space-x-4 w-full text-white transition-colors duration-300 ${
                  currentPath === "/dashboard"
                    ? "text-yellow-400 border-r-2 border-yellow-400"
                    : isOpen &&
              ...
              >
                <li
                  className={`grid place-items-center py-2 h-12 text-2xl relative ${
                    currentPath === "/dashboard" && "text-yellow-400"
                  }`}
                >
                  {!isOpen && <FaHome />}
                </li>
              ...
              >
                <li
                  className={`grid place-items-center py-2 h-12 text-xl relative ${
                    currentPath === "/courses" && "text-yellow-400"
                  }`}
                >
                  {!isOpen && <FaBookmark />}
                </li>
              ...
              >
                <li
                  className={`grid place-items-center py-2 h-12 text-2xl relative ${
                    currentPath === "/store" && "text-yellow-400"
                  }`}
                >
                  {!isOpen && <FaPerson />}
                </li>
              ...
              >
                <li
                  className={`grid place-items-center py-2 h-12 text-2xl relative ${
                    currentPath === "/pricing" && "text-yellow-400"
                  }`}
                >
                  {!isOpen && <FaDollarSign />}
                </li>
            ...
            <ul className="flex flex-col space-y-6">
              ...
              >
                <li
                  className={`grid place-items-center py-2 h-12 text-2xl relative ${
                    currentPath === "/settings" && "text-yellow-400"
                  }`}
                >
                  {!isOpen && <CgProfile />}
                </li>
